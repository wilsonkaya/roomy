...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rentalEvents = __webpack_require__(12);
	var reviewEvents = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetRental = function onGetRental(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.index(data).then(ui.onIndexSuccess).catch(ui.onIndexError);
	};

	var onGetMyRental = function onGetMyRental(event) {
	  event.preventDefault();
	  api.indexMyRental().then(ui.onSuccess).catch(ui.onError);
	};

	var onShowUpdate = function onShowUpdate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var rentalId = event.target.getAttribute('data-id');
	  api.show(rentalId).then(ui.onUpdateSucces).catch(ui.onUpdateError);
	};

	var onDeleteRental = function onDeleteRental(event) {
	  event.preventDefault();
	  var rentalId = event.target.getAttribute('data-id');
	  api.destroy(rentalId).then(ui.onDeleteSuccess(rentalId)).catch(ui.onDeleteError);
	};

	var onPatchRental = function onPatchRental(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var rentalId = event.target.getAttribute('data-id');
	  api.patch(data, rentalId).then(api.indexMyRental).then(ui.onSuccess).then(ui.onPatchSuccess).catch(ui.onPatchError);
	};

	var onPostRental = function onPostRental(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  // console.log(data)
	  api.post(data).then(api.indexMyRental).then(ui.onSuccess).then(ui.onPostSuccess).catch(ui.onPostError);
	};
	var onShowRentalForm = function onShowRentalForm() {
	  ui.onCreateNewRental();
	  $('.instructions').hide();
	};
	var onSingleRental = function onSingleRental() {
	  event.preventDefault();

	  var rentalId = event.target.getAttribute('data-id');
	  api.show(rentalId).then(ui.onSingleRentalShowSucces).catch(ui.onError);
	};

	var onShowMaP = function onShowMaP() {
	  event.preventDefault();
	...
	var rentalHandlers = function rentalHandlers() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var indexMyRental = function indexMyRental() {
	  return $.ajax({
	...
	var destroy = function destroy(rentalId) {
	  return $.ajax({
	...
	var patch = function patch(data, rentalId) {
	  return $.ajax({
	    url: config.apiOrigin + '/rentals/' + rentalId,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showRentalTemplate = __webpack_require__(15);
	var showAllRentalsTemplate = __webpack_require__(35);
	var updateRentalTemplate = __webpack_require__(36);
	var createRentalForm = __webpack_require__(37);
	var showSingleRental = __webpack_require__(38);
	var showSingleMap = __webpack_require__(39);
	...
	var onIndexSuccess = function onIndexSuccess(data) {
	  if (data.rentals.length === 0) {
	    ...
	    $('.clean-sign').text('');
	    var showRentalsHtml = showAllRentalsTemplate({ rentals: data.rentals });
	    $('#show').html(showRentalsHtml);
	    $('.instructions').hide();
	  }
	};

	var onIndexError = function onIndexError() {};
	...
	var onSuccess = function onSuccess(data) {
	  if (data.rentals.length === 0) {
	    ...
	    $('.clean-sign').text('');
	    var showRentalsHtml = showRentalTemplate({ rentals: data.rentals });
	    $('#show').html(showRentalsHtml);
	    $('.instructions').hide();
	  }
	};
	...
	var onDeleteSuccess = function onDeleteSuccess(rentalId) {
	  $('[data-id =' + rentalId + ']').remove();
	};
	var onDeleteError = function onDeleteError() {};
	var onPatchSuccess = function onPatchSuccess() {};
	var onPatchError = function onPatchError() {
	  alertify.error('Please fill in the forms with right type of data');
	};

	var onPostSuccess = function onPostSuccess() {};
	var onPostError = function onPostError() {
	  alertify.error('Please fill in the forms with right type of data');
	};

	var onUpdateSucces = function onUpdateSucces(data) {
	  var updateRentalHtml = updateRentalTemplate({ rental: data.rental });
	  $('#show').html(updateRentalHtml);
	};

	var onUpdateError = function onUpdateError() {};

	var onSingleRentalShowSucces = function onSingleRentalShowSucces(data) {
	  var showRentalHtml = showSingleRental({ rental: data.rental });
	  $('#show').html(showRentalHtml);
	};
	var onCreateNewRental = function onCreateNewRental() {
	  $('.clean-sign').text('');
	  var createRentalFormHtml = createRentalForm();
	  $('#show').html(createRentalFormHtml);
	};

	var onShowMaPSuccess = function onShowMaPSuccess(longitude, latitude) {
	  var showMapHtml = showSingleMap({ longitude: longitude, latitude: latitude });
	...
	module.exports = {
	  ...
	  onUpdateSucces: onUpdateSucces,
	  onUpdateError: onUpdateError,
	  onPatchSuccess: onPatchSuccess,
	  onPatchError: onPatchError,
	  onIndexSuccess: onIndexSuccess,
	  onIndexError: onIndexError,
	  onCreateNewRental: onCreateNewRental,
	  onPostSuccess: onPostSuccess,
	  onPostError: onPostError,
	  onSingleRentalShowSucces: onSingleRentalShowSucces,
	  onShowMaPSuccess: onShowMaPSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "     <div class=\"cards card-1\" data-id=\""
	    ...
	    + "</p>\n         <label class=\"card-label\">Owner:</label>\n         <p class=\"organizes\">"
	    ...
	    + "</p>\n         <label class=\"card-label\">Phone:</label>\n         <p class=\"organizes\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone : stack1), depth0))
	    + "</p>\n         <label class=\"card-label\">Description:</label>\n         <p class=\"organizes\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n       </div>\n\n     <button type=\"button\" class=\"btn btn-default show-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.rentals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "     <div class=\"cards card-1\" data-id=\""
	    ...
	    + "</p>\n         <label class=\"card-label\">Description:</label>\n         <p class=\"organizes\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n       </div>\n\n\n\n\n       <button type=\"button\" class=\"btn btn-default show-reviews\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Show Reviews</button>\n       <button type=\"button\" class=\"btn btn-default create-review\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Write Review</button>\n     </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- <div>\n  <form class=\"submit-update forms\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <input type=\"text\" name=\"rental[title]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\" class=\"clean-update inputs\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[name]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\" class=\"clean-update inputs\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[city]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.city : stack1), depth0))
	    + "\" class=\"clean-update inputs\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[description]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\" class=\"clean-update inputs\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[phone]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.phone : stack1), depth0))
	    + "\" class=\"clean-update inputs\" required=\"required\" maxlength=\"15\">\n    <input type=\"submit\" name=\"submit\">\n  </form>\n\n</div> -->\n\n\n<form class=\"white-pink submit-update \" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <h1>Create Rental<span>Please fill all the texts in the fields.</span></h1>\n    <p>\n    <label>\n    <span>Title :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[title]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\" class=\"clean-update\" placeholder=\"Rental Title\">\n    </label>\n    <label>\n    <span>Name :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[name]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.name : stack1), depth0))
	    + "\" class=\"clean-update\" placeholder=\"Owners Name\">\n    </label>\n    <label>\n    <span>City :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[city]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.city : stack1), depth0))
	    + "\" class=\"clean-update\" placeholder=\"Name of the City\">\n    </label>\n    <label>\n    <span>Phone :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[phone]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.phone : stack1), depth0))
	    + "\"  class=\"clean-update\" placeholder=\"Phone Number\">\n    </label>\n    <label>\n    <span>Description :</span>\n    <textarea id=\"message\" name=\"rental[description]\" class=\"clean-update\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.rental : depth0)) != null ? stack1.description : stack1), depth0))
	    + "</textarea>\n    </label>\n    <label><span>&nbsp;</span><input type=\"submit\" name=\"submit\"  class=\"button\" value=\"Update\"></label>\n  </p>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- <div>\n  <form id=\"createRental\" class =\"forms\">\n    <input type=\"text\" name=\"rental[title]\" class=\"clean-update inputs\" placeholder=\"Title\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[name]\" class=\"clean-update inputs\" placeholder=\"Name\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[city]\" class=\"clean-update inputs\" placeholder=\"City\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[description]\" class=\"clean-update inputs\" placeholder=\"Description\" required=\"required\" maxlength=\"50\">\n    <input type=\"text\" name=\"rental[phone]\" class=\"clean-update inputs\" placeholder=\"Phone\" required=\"required\" maxlength=\"50\">\n    <input type=\"submit\" name=\"submit\" class='formbut'>\n  </form>\n</div> -->\n\n<form id=\"createRental\" class=\"white-pink\">\n    <h1>Create Rental<span>Please fill all the texts in the fields.</span></h1>\n    <p>\n    <label>\n    <span>Title :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[title]\" class=\"clean-update\" placeholder=\"Rental Title\">\n    </label>\n    <label>\n    <span>Name :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[name]\" class=\"clean-update\" placeholder=\"Owners Name\">\n    </label>\n    <label>\n    <span>City :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[city]\" class=\"clean-update\" placeholder=\"Name of the City\">\n    </label>\n    <label>\n    <span>Phone :</span>\n    <input id=\"name\" type=\"text\" name=\"rental[phone]\" class=\"clean-update\" placeholder=\"Phone Number\">\n    </label>\n    <label>\n    <span>Description :</span>\n    <textarea id=\"message\" name=\"rental[description]\" class=\"clean-update\" placeholder=\"Description\"></textarea>\n    </label>\n    <label><span>&nbsp;</span><input type=\"submit\" name=\"submit\"  class=\"button\" value=\"Create\"></label>\n  </p>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"card card-inverse card-warning mb-3 text-center\">\n  <div class=\"card-block\">\n    <blockquote class=\"card-blockquote\">\n      <label class=\"col-sm-2 col-form-label\">Comment:</label>\n\n      <p>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetReview = function onGetReview(event) {
	  ...
	  api.index(obj).then(ui.onIndexSuccess).catch(ui.onIndexError);
	};

	var onGetMyReviews = function onGetMyReviews(event) {
	  event.preventDefault();
	  api.indexMyReview().then(ui.onSuccess).catch(ui.onError);
	};

	var onShowUpdate = function onShowUpdate(event) {
	  event.preventDefault();
	  var reviewId = event.target.getAttribute('data-id');
	  api.show(reviewId).then(ui.onUpdateSucces).catch(ui.onUpdateError);
	};

	var onDeleteReview = function onDeleteReview(event) {
	  event.preventDefault();
	  var reviewId = event.target.getAttribute('data-id');
	  api.destroy(reviewId).then(ui.onDeleteSuccess(reviewId)).catch(ui.onDeleteError);
	};

	var onPatchReviews = function onPatchReviews(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var reviewId = event.target.getAttribute('data-id');
	  api.patch(data, reviewId).then(api.indexMyReview).then(ui.onSuccess)
	  // .then(ui.onPatchSuccess)
	  .catch(ui.onPatchError);
	};

	var onPostReview = function onPostReview(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var rental = data.review.rentals;
	  var obj = {
	    rentals: rental
	  };
	  api.post(data).then(function () {
	    return api.index(obj);
	  }).then(ui.onIndexSuccess).catch(ui.onIndexError).catch(ui.onPostError);
	};
	...
	var reviewlHandlers = function reviewlHandlers() {
	...
	module.exports = {
	  reviewlHandlers: reviewlHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var indexMyReview = function indexMyReview() {
	  return $.ajax({
	...
	var destroy = function destroy(reviewId) {
	  return $.ajax({
	...
	var patch = function patch(data, reviewId) {
	  return $.ajax({
	    url: config.apiOrigin + '/reviews/' + reviewId,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showReviewsTemplate = __webpack_require__(43);
	var createReviewTemplate = __webpack_require__(44);
	var showMyReviewTemplate = __webpack_require__(45);
	var updateReviewTemplate = __webpack_require__(46);
	...
	var onIndexSuccess = function onIndexSuccess(data) {
	  if (data.reviews.length === 0) {
	    ...
	    var showReviewsHtml = showReviewsTemplate({ reviews: data.reviews });
	...
	var onSuccess = function onSuccess(data) {
	  if (data.reviews.length === 0) {
	    ...
	    var showMyReviewsHtml = showMyReviewTemplate({ reviews: data.reviews });
	...
	var onUpdateSucces = function onUpdateSucces(data) {
	  var updateReviewHtml = updateReviewTemplate({ review: data.review });
	  $('#show').html(updateReviewHtml);
	};

	var onCreateNewReview = function onCreateNewReview(data) {
	  var createReviewHtml = createReviewTemplate({ key: data });
	...
	module.exports = {
	  ...
	  onIndexSuccess: onIndexSuccess,
	  // onIndexError,
	  onCreateNewReview: onCreateNewReview,
	  // onPostSuccess,
	  onPostError: onPostError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- <div>\n  <form id=\"createReview\">\n    <div class=\"write-review-style\">\n      <label class=\"label-styl\">Write your review title <span class=\"max-fifty\">(50 characters max)</span></label>\n      <input type=\"text\" name=\"review[name]\" class=\"clean-update review-title\" placeholder=\"Name\" required=\"required\" maxlength=\"20\">\n    </div>\n    <div class=\"write-review-style\">\n      <label class=\"label-styl\">Rate your stay <span class=\"normal\">- Select your star rating!</span></label>\n      <fieldset class=\"rating\">\n      <input type=\"radio\" id=\"star5\" name=\"review[rating]\" value=\"5\" /><label for=\"star5\">5 stars</label>\n      <input type=\"radio\" id=\"star4\" name=\"review[rating]\" value=\"4\" /><label for=\"star4\">4 stars</label>\n      <input type=\"radio\" id=\"star3\" name=\"review[rating]\" value=\"3\" /><label for=\"star3\">3 stars</label>\n      <input type=\"radio\" id=\"star2\" name=\"review[rating]\" value=\"2\" /><label for=\"star2\">2 stars</label>\n      <input type=\"radio\" id=\"star1\" name=\"review[rating]\" value=\"1\"  /><label for=\"star1\">1 star</label>\n      </fieldset>\n    </div>\n    <div class=\"write-review-style\">\n      <label class=\"label-styl\">Write your review<span class=\"normal\">- Share your experience!</span></label>\n      <textarea name=\"review[comment]\"  rows=\"5\" maxlength=\"2500\" placeholder=\"Your overall impression of the property and your stay\"></textarea>\n    </div>\n      <input type=\"hidden\" name=\"review[rentals]\" class=\"clean-update\" value=\""
	    + alias4(((helper = (helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\">\n    <input type=\"submit\" name=\"submit\">\n  </form>\n</div> -->\n      <!-- <input type=\"text\" name=\"review[comment]\" class=\"clean-update\" placeholder=\"Comment\" required=\"required\" maxlength=\"50\"> -->\n\n<form id=\"createReview\"  class=\"smart-green\">\n<h1>Contact Form<span>Please fill all the texts in the fields.</span></h1>\n<p>\n  <label>\n    <span>Review Title :</span>\n  <!-- <input id=\"name\" type=\"text\" name=\"name\" placeholder=\"Your Full Name\"> -->\n  <input id=\"name\" type=\"text\" name=\"review[name]\" class=\"clean-update\" placeholder=\"Name\" required=\"required\" maxlength=\"20\">\n  </label>\n  <label>\n    <span>Your Email :</span>\n    <fieldset class=\"rating\">\n    <input type=\"radio\" id=\"star5\" name=\"review[rating]\" value=\"5\" /><label for=\"star5\">5 stars</label>\n    <input type=\"radio\" id=\"star4\" name=\"review[rating]\" value=\"4\" /><label for=\"star4\">4 stars</label>\n    <input type=\"radio\" id=\"star3\" name=\"review[rating]\" value=\"3\" /><label for=\"star3\">3 stars</label>\n    <input type=\"radio\" id=\"star2\" name=\"review[rating]\" value=\"2\" /><label for=\"star2\">2 stars</label>\n    <input type=\"radio\" id=\"star1\" name=\"review[rating]\" value=\"1\"  /><label for=\"star1\">1 star</label>\n    </fieldset>\n    <!-- <br> -->\n    <input type=\"hidden\" name=\"review[rentals]\" class=\"clean-update\" value=\""
	    + alias4(((helper = (helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\">\n    <!-- <br> -->\n  </label>\n  <label>\n    <span>Message :</span>\n    <textarea id=\"message\" maxlength=\"50\" name=\"review[comment]\" placeholder=\"Your Message to Us\"></textarea>\n  </label>\n  <label><span>&nbsp;</span><input type=\"submit\" class=\"button\" value=\"submit\"></label>\n</p>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"cardss card-1\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div class=\"room\">\n  </div>\n\n\n  <label class=\"card-label\">Comment:</label>\n  <p id=\"super\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</p>\n  <label class=\"card-label\">Rating:</label>\n  <div class=\"star-location\">\n    <span class=\"rating-static rating-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + "\"></span>\n  </div>\n  <button type=\"button\" class=\"btn btn-default update-myreview\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Update review</button>\n  <button type=\"button\" class=\"btn btn-default delete-myreview\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"button\">Delete review</button>\n\n\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- <div>\n  <form class=\"submit-review-update smart-green\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <input type=\"text\" name=\"review[comment]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.comment : stack1), depth0))
	    + "\" class=\"clean-update\" required=\"required\" maxlength=\"50\">\n    <fieldset class=\"rating\">\n    <input type=\"radio\" id=\"star5\" name=\"review[rating]\" value=\"5\" /><label for=\"star5\">5 stars</label>\n    <input type=\"radio\" id=\"star4\" name=\"review[rating]\" value=\"4\" /><label for=\"star4\">4 stars</label>\n    <input type=\"radio\" id=\"star3\" name=\"review[rating]\" value=\"3\" /><label for=\"star3\">3 stars</label>\n    <input type=\"radio\" id=\"star2\" name=\"review[rating]\" value=\"2\" /><label for=\"star2\">2 stars</label>\n    <input type=\"radio\" id=\"star1\" name=\"review[rating]\" value=\"1\" /><label for=\"star1\">1 star</label>\n    </fieldset>\n    <input type=\"hidden\" name=\"review[rentals]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.rentals : stack1), depth0))
	    + "\" class=\"clean-update\">\n    <input type=\"submit\" name=\"submit\">\n  </form>\n\n</div> -->\n\n<form class=\"submit-review-update smart-green\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n<h1>Update Review<span>Please fill all the texts in the fields.</span></h1>\n<p>\n  <label>\n    <span>Review:</span>\n  <!-- <input id=\"name\" type=\"text\" name=\"name\" placeholder=\"Your Full Name\"> -->\n  <!-- <input type=\"text\" name=\"review[comment]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.comment : stack1), depth0))
	    + "\" class=\"clean-update\" required=\"required\" maxlength=\"50\"> -->\n  <textarea name=\"review[comment]\" rows=\"8\" cols=\"80\" class=\"clean-update\" required=\"required\" maxlength=\"50\"> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.comment : stack1), depth0))
	    + "</textarea>\n  </label>\n  <label>\n    <span>Rate your stay :</span>\n    <fieldset class=\"rating\">\n    <input type=\"radio\" id=\"star5\" name=\"review[rating]\" value=\"5\" /><label for=\"star5\">5 stars</label>\n    <input type=\"radio\" id=\"star4\" name=\"review[rating]\" value=\"4\" /><label for=\"star4\">4 stars</label>\n    <input type=\"radio\" id=\"star3\" name=\"review[rating]\" value=\"3\" /><label for=\"star3\">3 stars</label>\n    <input type=\"radio\" id=\"star2\" name=\"review[rating]\" value=\"2\" /><label for=\"star2\">2 stars</label>\n    <input type=\"radio\" id=\"star1\" name=\"review[rating]\" value=\"1\" /><label for=\"star1\">1 star</label>\n    </fieldset>\n    <input type=\"hidden\" name=\"review[rentals]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.rentals : stack1), depth0))
	    + "\" class=\"clean-update\">\n  </label>\n\n  <label><span>&nbsp;</span><input type=\"submit\" class=\"button update-button\" value=\"submit\"></label>\n</p>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a7ce18dec9affaf5ab51395ac967ae78.png";

/***/ }),
/* 57 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "d1f00383102f87c5ab4a4cf03e3dc8b4.png";
